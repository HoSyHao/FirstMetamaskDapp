...
const MetadataFormSingle = ({ metadataInputs, setMetadataInputs, handleMetadataSubmit, setIsMetadataFormOpen, isMinting }) => {
  ...
  useEffect(() => {
    ...
    if (metadataInputs.nfts[0].image) {
      setImagePreview(URL.createObjectURL(metadataInputs.nfts[0].image));
    } else if (metadataInputs.nfts[0].metadata?.image) {
      setImagePreview(metadataInputs.nfts[0].metadata.image);
    }
  }, [metadataInputs]);
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-gray-900 p-6 rounded-lg shadow-lg w-full max-w-2xl relative z-10">
        <h3 className="text-lg font-semibold text-blue-300 mb-4">Enter Metadata for NFT #{metadataInputs.nfts[0].tokenId}</h3>
        <div className="flex">
...
export default MetadataFormSingle;